...
inline
std::error_condition make_error_condition(MediaWrapper::AV::Errors errc) noexcept
{
    return std::error_condition(static_cast<int>(errc), MediaWrapper::AV::avcpp_category());
}

inline
std::error_code make_error_code(MediaWrapper::AV::Errors errc) noexcept
{
    return std::error_code(static_cast<int>(errc), MediaWrapper::AV::avcpp_category());
}
...
template<typename Exception = MediaWrapper::AV::Exception>
 ...
 */
template<typename Category, typename Exception = MediaWrapper::AV::Exception>
...
template<typename T, typename Exception = MediaWrapper::AV::Exception>
...
namespace std {
template<> struct is_error_condition_enum<MediaWrapper::AV::Errors> : public true_type {};
